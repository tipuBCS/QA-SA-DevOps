...
export default function AdminPage() {
  ...
  return (
    <Container sx={{ py: 4 }}>
      ...
      {tab === 0 && <BuildingsTab />}
      {tab === 1 && <Typography color="text.secondary">Rooms management coming soon.</Typography>}
      {tab === 2 && <Typography color="text.secondary">Room types management coming soon.</Typography>}
    </Container>
  );
}
